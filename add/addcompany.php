    ...
    <div class="content-right">
        <div class="content-product">
            ...
            if (isset($_GET['action']) && $_GET['action']=='add') {
                ...
                $sql3 = "INSERT INTO nxb VALUES ('$manxb', '$tennxb')";
                $result3 = mysqli_query($con, $sql3);
                if ($result3) {
                    echo 'Them nxb thanh cong';
                }else {
                    echo 'Them nxb khong thanh cong';
                }
                mysqli_close($con);
            }
            ...
            <div class="add-book">
                <form action="../add/addcompany.php?action=add" method="POST" enctype="multipart/form-data">
                    <div class="add-detail">
                        <label for="">Mã NXB: </label>
                        <input type="text" name="manxb" id="" style="margin-left: 7.7rem">
                    </div>
                    <div class="add-detail">
