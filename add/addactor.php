    ...
    <div class="content-right">
        <div class="content-product">
            ...
            if (isset($_GET['action']) && $_GET['action']=='add') {
                ...
                $sql3 = "INSERT INTO tacgia VALUES ('$matg', '$tentgia')";
                $result3 = mysqli_query($con, $sql3);
                if ($result3) {
                    echo 'Them tac gia thanh cong';
                }else {
                    echo 'Them tac gia khong thanh cong';
                }
                mysqli_close($con);
            }
            ...
            <div class="add-book">
                <form action="../add/addactor.php?action=add" method="POST" enctype="multipart/form-data">
                    <div class="add-detail">
                        <label for="">Mã Tác Giả: </label>
                        <input type="text" name="matg" id="" style="margin-left: 7.7rem">
                    </div>
                    <div class="add-detail">
