        ...
        <div class="content-product">
            ...
            <?php
                if (isset($_GET['action']) && $_GET['action']=='add') {
                    ...
                    $sql3 = "INSERT INTO taikhoan VALUES ('$tentk', '$mk')";
                    $result3 = mysqli_query($con, $sql3);
                    if ($result3) {
                        echo 'Them tai khoan thanh cong';
                    }else {
                        echo 'Them tai khoan khong thanh cong';
                    }
                    mysqli_close($con);
                }
            ...
            <div class="add-book">
                <form action="../add/addaccount.php?action=add" method="POST" enctype="multipart/form-data">
                    <div class="add-detail">
                        <label for="">Tên Tài Khoản: </label>
                        <input type="text" name="tentk" id="" style="margin-left: 4.2rem">
                    </div>
                    <div class="add-detail">
                        <label for="">Mật Khẩu: </label>
                        <input type="text" name="matkhau" id="">
                    </div>
