    ...
    <div class="content-right">
        <div class="content-product">
            <div class="product-title-add">
                ...
                <div class="btn-add">
                    <a href="./add/addaccount.php">Thêm tài khoản</a>
                </div>
            </div>
            <table>
                <tr>
                    <th style="width:18rem;">Tên Tài Khoản</th>
                    <th>Mật Khẩu (MD5)</th>
                    <th>Lựa Chọn</th>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        <td><?=$row['tentk']?></td>
                        <td><?= md5($row['matkhau'])?></td>
                        <td class="option">
                            <a href="./update/upaccount.php?id=<?=$row['tentk']?>">Sửa</a>
                            <a href="./delete/deleteaccount.php?id=<?=$row['tentk']?>">Xoá</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
