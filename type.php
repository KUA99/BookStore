    ...
    <div class="content-right">
        <div class="content-product">
            <div class="product-title-add">
                ...
                <div class="btn-add">
                    <a href="./add/addtype.php">Thêm loại sách</a>
                </div>
            </div>
            <table>
                <tr>
                    <th style="width:18rem;">Mã Loại Sách</th>
                    <th>Tên Loại Sách</th>
                    <th>Lựa Chọn</th>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><?=$row['tenloai']?></td>
                        <td class="option">
                            <a href="./update/uptype.php?id=<?=$row['maloai']?>">Sửa</a>
                            <a href="./delete/deletetype.php?id=<?=$row['maloai']?>">Xoá</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
