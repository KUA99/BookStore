    ...
    <div class="content-right">
        <div class="content-product">
            ...
            if (isset($_GET['action']) && $_GET['action']=='add') {
                ...
                $sql3 = "UPDATE loaisach SET tenloai='$tenloai' WHERE maloai=$id3";
                $result3 = mysqli_query($con, $sql3);

                if ($result3) {
                    echo 'Sua loai san pham thanh cong';
                }else {
                    echo 'Sua loai san pham khong thanh cong';
                }
                mysqli_close($con);
            }
            ...
            <div class="add-book">
                ...
                $sql4 = "SELECT * FROM loaisach WHERE maloai='$id'";
                $result4 = mysqli_query($con, $sql4);
                while ($row4 = mysqli_fetch_array($result4)) {

                    ?>
                    <form action="../update/uptype.php?action=add&id2=<?=$id?>" method="POST" enctype="multipart/form-data">

                        <div class="add-detail">
                            <label for="">Tên Loại: </label>
                            <input type="text" name="tenloai" value="<?=$row4['tenloai']?>" style="margin-left: 4.3rem;">
                        </div>
                        <div class="add-detail">
