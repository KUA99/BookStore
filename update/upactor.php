    ...
    <div class="content-right">
        <div class="content-product">
            ...
            if (isset($_GET['action']) && $_GET['action']=='add') {
                $tentg = $_POST['tentg'];
                $id3 = $_GET['id2'];
                $sql3 = "UPDATE tacgia SET tentg='$tentg' WHERE matg=$id3";
                $result3 = mysqli_query($con, $sql3);

                if ($result3) {
                    echo 'Sua tac gia thanh cong';
                }else {
                    echo 'Sua tac gia khong thanh cong';
                }
                mysqli_close($con);
            }
            ...
            <div class="add-book">
                ...
                $sql4 = "SELECT * FROM tacgia WHERE matg='$id'";
                $result4 = mysqli_query($con, $sql4);
                while ($row4 = mysqli_fetch_array($result4)) {

                    ?>
                    <form action="../update/upactor.php?action=add&id2=<?=$id?>" method="POST" enctype="multipart/form-data">

                        <div class="add-detail">
                            <label for="">Tên Tác Giả: </label>
                            <input type="text" name="tentg" value="<?=$row4['tentg']?>" style="margin-left: 4.3rem;">
                        </div>
                        <div class="add-detail">
