    ...
    <div class="content-right">
        <div class="content-product">
            <div class="product-title-add">
                ...
                <div class="btn-add">
                    <a href="./add/addcompany.php">Thêm NXB</a>
                </div>
            </div>
            <table>
                <tr>
                    <th style="width:18rem;">Mã Nhà Xuất Bản</th>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><?=$row['tennxb']?></td>
                        <td class="option">
                            <a href="./update/upcompany.php?id=<?=$row['manxb']?>">Sửa</a>
                            <a href="./delete/deletecompany.php?id=<?=$row['manxb']?>">Xoá</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
