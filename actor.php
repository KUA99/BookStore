    ...
    <div class="content-right">
        <div class="content-product">
            <div class="product-title-add">
                ...
                <div class="btn-add">
                    <a href="./add/addactor.php">Thêm tác giả</a>
                </div>
            </div>
            <table>
                <tr>
                    <th style="width:18rem;">Mã Tác Giả</th>
                    <th>Tên Tác Giả</th>
                    <th>Lựa Chọn</th>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><?=$row['tentg']?></td>
                        <td class="option">
                            <a href="./update/upactor.php?id=<?=$row['matg']?>">Sửa</a>
                            <a href="./delete/deleteactor.php?id=<?=$row['matg']?>">Xoá</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
